...
function spawnTempoBasicPattern(mNumbSpawn)
    ...
    elseif mNumbSpawn == 2 and getProtocolSides() == 6 then
        ...
        cBarrageDoubleHoled(_side, 0, 0, march31oPat_thickness); t_wait(customizeTempoPatternDelay(0.5))
        cBarrageDoubleHoled(_side + getHalfSides(), 0, 0, march31oPat_thickness); t_wait(customizeTempoPatternDelay(0.5))
    ...
    elseif mNumbSpawn == 6 then spMarch31osTunnel(_side, march31oPat_thickness * 1.75, (GLOBAL_TEMPO > 120 and 2) or 3, 2, 0, 2, 0, nil, 1, 1, false, false, false, 1, 1, 1, 0, 0, (GLOBAL_TEMPO > 120 and 3) or 2, u_rndInt(0, 1)); t_wait(customizeTempoPatternDelay(1));
    ...
    elseif mNumbSpawn == 19 then
        ...
        spMarch31osTunnel(_side, march31oPat_thickness, 6, 2, 0, 2, 0, nil, 1, 1, false, false, false, 1, _gapOffset, getProtocolSides() - (_gapOffset + 1), 0, 0, 1, u_rndInt(0, 1)); t_wait(customizeTempoPatternDelay(2));
    elseif mNumbSpawn == 20 and getProtocolSides() > 4 then spMarch31osTunnel(_side, march31oPat_thickness, (GLOBAL_TEMPO > 160 and 1) or 2, 2, 0, 3, 1, nil, 1, 1, true, false, false, 1, 1, 1, 0, 0, (GLOBAL_TEMPO > 160 and 3) or 2, u_rndInt(0, 1)); t_wait(customizeTempoPatternDelay(1));
...
function spawnTempoBasicPatternTrip(mNumbSpawn)
    ...
    elseif mNumbSpawn == 3 then spMarch31osTunnel(_side, march31oPat_thickness, (GLOBAL_TEMPO > 100 and 2) or 3, 2, 0, 2, 0, nil, 1, 1, false, false, false, 1, (getProtocolSides() > 6 and 3) or 2, nil, 0, nil, 2 * (GLOBAL_TEMPO > 100 and 1 or 0.666), u_rndInt(0, 1)); t_wait(customizeTempoPatternDelay(1));
    ...
    elseif mNumbSpawn == 5 then spMarch31osVortaBarrage(_side, march31oPat_thickness, 1, 0, 1, {}, 0, 0, 1, getRandomDir()); t_wait(customizeTempoPatternDelay(2));
    elseif mNumbSpawn == 6 then spMarch31osBarrageSpiral(_side, march31oPat_thickness, 4, 1, 2, 0, 1, false, 1, getRandomDir()); t_wait(customizeTempoPatternDelay(1));
    elseif mNumbSpawn == 7 then spMarch31osBarrageSpiral(_side, march31oPat_thickness, 4, 1, 2, 1, 1, false, 1, getRandomDir()); t_wait(customizeTempoPatternDelay(1));
    elseif mNumbSpawn == 8 then spMarch31osBarrageSpiral(_side, march31oPat_thickness, 2, 1, 1, 2, 1, true, 2, u_rndInt(0, 1)); t_wait(customizeTempoPatternDelay(1));
    elseif mNumbSpawn == 9 then spMarch31osBackAndForthTunnelCentral(_side, march31oPat_thickness, 4, 0, 2, 0, 0, 0, 0, nil, 1, 1, false, false, false, 1, 1, u_rndInt(0, 1)); t_wait(customizeTempoPatternDelay(2));
...
function spawnTempoBasicPatternQuint(mNumbSpawn)
    ...
    elseif mNumbSpawn == 3 then
        ...
        cWallMirror(_side, 2, march31oPat_thickness); t_wait(customizeTempoPatternDelay(0.5))
        cBarrage(_side, march31oPat_thickness); t_wait(customizeTempoPatternDelay(0.5))
        cBarrageDoubleHoled(_side, 0, 0, march31oPat_thickness); t_wait(customizeTempoPatternDelay(0.5))
        cBarrageDoubleHoled(_side + getHalfSides(), 0, 0, march31oPat_thickness); t_wait(customizeTempoPatternDelay(0.5))
