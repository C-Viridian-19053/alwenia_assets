...
function spawnSHPattern(mNumbSpawn, mSpawnType, bIsHyper, bIsFinalEngage)
    ...
    if mSpawnType == 0 then
        ...
        elseif mNumbSpawn == 14 and (bIsHyper) and getProtocolSides() == 6 then pMarch31osVortaBarrage(_side, march31oPat_thickness, 4, 0, 0, {}, 0, 0, 1, 1, 1);
    ...
    elseif mSpawnType == 1 then
        ...
        elseif mNumbSpawn == 10 and (bIsHyper)     then pMarch31osExWhirlwind(_side, 4, 1, 0, 0, getPolySides(3, "floor"), 1, true, 1, 1, getRandomDir(), 1, 1, 1, true);
    ...
    elseif mSpawnType == 2 then
        ...
        elseif mNumbSpawn == 10                      then pMarch31osExWhirlwind(_side, 4, 1, 0, 0, getPolySides(3, "floor"), 1, true, 1, 1, getRandomDir(), 1, 1, 1, true);
        elseif mNumbSpawn == 11 and (bIsFinalEngage) then pMarch31osVortaBarrage(_side, march31oPat_thickness, 4, 0, 0, {}, 0, 0, 1, 1, 1);
...
function spawnBabaV2Pattern(mNumbSpawn)
    ...
    elseif mNumbSpawn == 17 then pMarch31osDoubleHoledBarrageSpiral(_side, march31oPat_thickness, u_rndInt(4, 5), 0, 1, 1, 1, getRandomDir())
    elseif mNumbSpawn == 18 then pMarch31osDoubleHoledBarrageLeftRights(_side, march31oPat_thickness, u_rndInt(4, 5), 0, 1, 1, 1, getRandomDir())
    elseif mNumbSpawn == 19 then pMarch31osDoubleHoledBarrageInversions(_side, march31oPat_thickness, u_rndInt(4, 5), 0, true, 1, 1, getRandomDir())
