...
--[[
    ...
    void pLuigisAccurateBatNew(_side, _hasContainedStart, _hasContainedEnd, _neighContainedStart, _neighContainedEnd, _design, _isOdd, _isInverted, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultOfSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
...
function pLuigisAccurateBatNew(_side, _hasContainedStart, _hasContainedEnd, _neighContainedStart, _neighContainedEnd, _design, _isOdd, _isInverted, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultOfSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    -- optional args
