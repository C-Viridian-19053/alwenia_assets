...
--[[
    void pMarch31osBarrageLeftRights(_side, _thickness, _iter, _gap, _distance, _isDelayDistance, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osBarrageLeftRights(_side, _thickness, _iter) --, 1, 1, false, 1, 1, u_rndInt(0, 1), false, 0, 1, 1, 2, false, false
    void pMarch31osRandomBarragesNrepeats(_side, _thickness, _iter, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osRandomBarragesNrepeats(_side, _thickness, _iter) --, 1, 1, false, 0, 1, 1, 2, false, false
    void pMarch31osRandomBarragesNdistance(_side, _thickness, _iter, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osRandomBarragesNdistance(_side, _thickness, _iter) --, 1, 1, false, 0, 1, 1, 2, false, false
    void pMarch31osWallDisplacer(_side, _thickness, _iter, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osWallDisplacer(_side, _thickness, _iter) --, 1, 1, false, 0, 1, 1, 2, false, false
    void pMarch31osDoubleBarrageSpiralAcross(_side, _thickness, _iter, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osDoubleBarrageSpiralAcross(_side, _thickness, _iter) --, 1, 1, false, 0, 1, 1, 2, false, false
    void pMarch31osAbstractBarrage(_side, _thickness, _iter, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osAbstractBarrage(_side, _thickness, _iter) --, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osWallExFillerSpiral(_side, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osWallExFillerSpiral(_side) --, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osDoubleHoledBarrageSpiral(_side, _thickness, _iter, _extraHole, _delMult, _scale, _exMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osDoubleHoledBarrageSpiral(_side, _thickness, _iter) --, 0, 1, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osDoubleHoledBarrageLeftRights(_side, _thickness, _iter, _extraHole, _delMult, _scale, _exMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osDoubleHoledBarrageLeftRights(_side, _thickness, _iter) --, 0, 1, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osDoubleHoledBarrageInversions(_side, _thickness, _iter, _extraHole, _isSpiral, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osDoubleHoledBarrageInversions(_side, _thickness, _iter) --, 0, 1, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osCtoCIBarrage(_side, _thickness, _iter, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osCtoCIBarrage(_side, _thickness, _iter) --, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osJumbleBarrage(_side, _thickness, _iter, _chance, _delMult, _scale, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osJumbleBarrage(_side, _thickness, _iter) --, getProtocolSides() - 2, 1, 1, 0, 1, 1, 2, false, false
    void pMarch31osSprayBarrage(_side, _thickness, _iter, _delay, _extra, _delMult, _scale, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osSprayBarrage(_side, _thickness, _iter) --, 4, 2, 1, 1, 0, 1, 1, 2, false, false
    void pMarch31osOddAltBarrage(_side, _thickness, _iter, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osOddAltBarrage(_side, _thickness, _iter) --, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osEvenAltBarrage(_side, _thickness, _iter, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osEvenAltBarrage(_side, _thickness, _iter) --, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osAltHalfBarrage(_side, _thickness, _iter, _extraWalls, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osAltHalfBarrage(_side, _thickness, _iter) --, 0, 1, 1, 0, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osAltTrapBarrage(_side, _thickness, _iter, _gap, _delMult, _scale, _barrageDir, _offsetType, _offsetMult, _offsetDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osAltTrapBarrage(_side, _thickness, _iter) --, 1, 1, 1, getRandomDir(), 0, getRandomDir(), 1, false, 0, 1, 1, 2, false, false
    void pMarch31osCustomizedAltTrapBarrage(_side, _thickness, _iter, _sidedir1Neighbors, _sidedirmin1Gap, _delMult, _scale, _barrageDir, _offsetType, _offsetMult, _offsetDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osRandomWhirlwind(_side, _iter, _extra, _mirror_step, _pos_spacing, _seamless, _delMult, _scale, _loopDir, _cleanAmountStart, _cleanAmountEnd, _is_full, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osRandomWhirlwind(_side, _iter) --0, math.floor(getProtocolSides() / 3), 1, false, 1, 1, getRandomDir(), 0, false, 0, 1, 1, 2, false, false
    void pMarch31osFullWhirlwind(_side, _iter, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osFullWhirlwind(_side, _iter) --, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osFullWhirlwindPrototype(_side, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    void pMarch31osFullWhirlwindPrototype(_side) --, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void pMarch31osZigZagSpiral(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _width, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
...
function pMarch31osBarrageLeftRights(_side, _thickness, _iter, _gap, _distance, _isDelayDistance, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    pMarch31osBarrageTypeBase(_side, _thickness, _iter, _gap, 1, 1, anythingButNil(_distance, 1), _loopDir, false, (getBooleanNumber(_isDelayDistance) and (anythingButNil(_distance, 1) * 0.333 + 0.667) or 1) * _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
end

function pMarch31osRandomBarragesNrepeats(_side, _thickness, _iter, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
...
function pMarch31osWallDisplacer(_side, _thickness, _iter, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    _side = anythingButNil(_side, u_rndInt(0, getProtocolSides() - 1)); _iter = anythingButNil(_iter, u_rndInt(3, 6)); _delMult = anythingButNil(_delMult, 1); _scale = anythingButNil(_scale, 1);
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
...
function pMarch31osDoubleBarrageSpiralAcross(_side, _thickness, _iter, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(1, 3)); _delMult = anythingButNil(_delMult, 1); _scale = anythingButNil(_scale, 1);
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
    ...
    for a = 0, (math.floor(getProtocolSides() / 2) * 2) * _iter, 1 do
        ...
        if (a % (math.floor(getProtocolSides() / 2) * 2)) == 0 then cBarrage(_side, p_getTunnelPatternCorridorThickness() * _scale); _barrageOffset = 0
...
function pMarch31osWallExFillerSpiral(_side, _thickness, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    ...
    for a = 0, getProtocolSides() - 2, 1 do
        ...
        if _barrageLoopDir > 0 then cWallEx(_curSide + a, a, p_getTunnelPatternCorridorThickness() * _scale);
...
function pMarch31osDoubleHoledBarrageSpiral(_side, _thickness, _iter, _extraHole, _delMult, _scale, _exMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    pMarch31osBarrageTypeBase(_side, _thickness, anythingButNil(_iter, u_rndInt(4, 5)), 1, 2 + anythingButNil(_extraHole, 0), 0, anythingButNil(_exMult, 1), _loopDir, false, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
end

function pMarch31osDoubleHoledBarrageLeftRights(_side, _thickness, _iter, _extraHole, _delMult, _scale, _exMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    pMarch31osBarrageTypeBase(_side, _thickness, anythingButNil(_iter, u_rndInt(4, 5)), 1, 2 + anythingButNil(_extraHole, 0), 1, anythingButNil(_exMult, 1), _loopDir, false, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
end

function pMarch31osDoubleHoledBarrageInversions(_side, _thickness, _iter, _extraHole, _isSpiral, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    pMarch31osBarrageTypeBase(_side, _thickness, anythingButNil(_iter, u_rndInt(4, 5)), 1, 2 + anythingButNil(_extraHole, 0), (getBooleanNumber(_isSpiral) and 0) or 2, (getBooleanNumber(_isSpiral) and math.floor(getProtocolSides() / 2)) or 1, _loopDir, false, _delMult, _scale, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
end

function pMarch31osCtoCIBarrage(_side, _thickness, _iter, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(4, 8)); _delMult = anythingButNil(_delMult, 1); _scale = anythingButNil(_scale, 1);
    if _loopDir == nil or _loopDir == 0 then _loopDir = getRandomDir(); end
    if _loopDir < -1 then _loopDir = -1 elseif _loopDir > 1 then _loopDir = 1; end
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
    ...
    for a = 0, _iter, 1 do
        ...
        if _barrageLoopDir > 0 then cBarrage(_curSide, p_getTunnelPatternCorridorThickness() * _scale);
        else cBarrageExHoles(_curSide, 1, p_getTunnelPatternCorridorThickness() * _scale);
        end
...
function pMarch31osJumbleBarrage(_side, _thickness, _iter, _chance, _delMult, _scale, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(3, 4)); _delMult = anythingButNil(_delMult, 1); _scale = anythingButNil(_scale, 1);
    ...
    for a = 0, _iter, 1 do
        ...
        for i = 1, getProtocolSides(), 1 do
            if _barrageLoopDir > 0 then
                if _barrageLoopDirAlt == -1 then cWall(_curSide + _barrageOffset, p_getTunnelPatternCorridorThickness() * _scale); cWall(_curSide + _barrageOffset, p_getTunnelPatternCorridorThickness() * _scale); end
            else
                if _barrageLoopDirAlt >= 0 then cWall(_curSide + _barrageOffset, p_getTunnelPatternCorridorThickness() * _scale); cWall(_curSide + _barrageOffset, p_getTunnelPatternCorridorThickness() * _scale); end
            end
...
function pMarch31osAltHalfBarrage(_side, _thickness, _iter, _extraWalls, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(4, 6)); _delMult = anythingButNil(_delMult, 1); _scale = anythingButNil(_scale, 1); _extraWalls = anythingButNil(_extraWalls, 0);
    ...
    for a = 0, _iter, 1 do
        ...
        if _barrageLoopDir > 0 then
            for i = 1, getHalfSides() + _extraWalls, 1 do cWall(_curSide + i, p_getTunnelPatternCorridorThickness() * _scale); end
        else
...
function pMarch31osAltTrapBarrage(_side, _thickness, _iter, _gap, _delMult, _scale, _barrageDir, _offsetType, _offsetMult, _offsetDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    ...
    for a = 0, _iter, 1 do
        ...
        for i = 1, getProtocolSides(), 1 do
            if _barrageLoopDir < 0 then
                if i > _gap then cWall(_curSide + i + (((math.floor(a * 0.5)) % _typeModeModuloStat) * _typeModeStat * _offsetLoopDir), p_getTunnelPatternCorridorThickness() * _scale); end
...
function pMarch31osCustomizedAltTrapBarrage(_side, _thickness, _iter, _sidedir1Neighbors, _sidedirmin1Gap, _delMult, _scale, _barrageDir, _offsetType, _offsetMult, _offsetDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    ...
    for a = 0, _iter, 1 do
        ...
        if _barrageLoopDir < 0 then cBarrageN(_curSide + (((math.floor(a * 0.5)) % _typeModeModuloStat) * _typeModeStat * _typeModeMultStat * _offsetLoopDir), _sidedir1Neighbors, p_getTunnelPatternCorridorThickness() * _scale);
...
function pMarch31osRandomWhirlwind(_side, _iter, _extra, _mirror_step, _pos_spacing, _seamless, _delMult, _scale, _loopDir, _cleanAmountStart, _cleanAmountEnd, _is_full, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(6, 8)); _delMult = anythingButNil(_delMult, 1); _scale = anythingButNil(_scale, 1);
...
function pMarch31osFullWhirlwind(_side, _iter, _delMult, _scale, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _thickMult_nonSpd, _spdIs_greaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(7, 11)); _delMult = anythingButNil(_delMult, 1); _scale = anythingButNil(_scale, 1);
    if _loopDir == nil or _loopDir == 0 then _loopDir = getRandomDir(); end
    if _loopDir < -1 then _loopDir = -1 elseif _loopDir > 1 then _loopDir = 1; end
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
