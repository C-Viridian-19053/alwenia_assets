--[[
    void pMarch31osBarrageLeftRights(_side, _thickness, _iter, _gap, _distance, _isDelayDistance, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osBarrageLeftRights(_side, _thickness, _iter) --, 1, 1, false, 1, 1, u_rndInt(0, 1), false, false, 0, 1, 1, 2
    void pMarch31osWallDisplacer(_side, _thickness, _iter, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osWallDisplacer(_side, _thickness, _iter) --, 1, 1, false, false, 0, 1, 1, 2
    void pMarch31osDoubleBarrageSpiralAcross(_side, _thickness, _iter, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osDoubleBarrageSpiralAcross(_side, _thickness, _iter) --, 1, 1, false, false, 0, 1, 1, 2
    void pMarch31osAbstractBarrage(_side, _thickness, _iter, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osAbstractBarrage(_side, _thickness, _iter) --, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osWallExFillerSpiral(_side, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osWallExFillerSpiral(_side) --, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osDoubleHoledBarrageSpiral(_side, _thickness, _iter, _extraHole, _delMult, _sizeMult, _distPosMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osDoubleHoledBarrageSpiral(_side, _thickness, _iter) --, 0, 1, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osDoubleHoledBarrageLeftRights(_side, _thickness, _iter, _extraHole, _delMult, _sizeMult, _distPosMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osDoubleHoledBarrageLeftRights(_side, _thickness, _iter) --, 0, 1, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osDoubleHoledBarrageInversions(_side, _thickness, _iter, _extraHole, _isSpiral, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osDoubleHoledBarrageInversions(_side, _thickness, _iter) --, 0, 1, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osCtoCIBarrage(_side, _thickness, _iter, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osCtoCIBarrage(_side, _thickness, _iter) --, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osJumbleBarrage(_side, _thickness, _iter, _chance, _delMult, _sizeMult, _skipEndDelay, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osJumbleBarrage(_side, _thickness, _iter) --, getProtocolSides() - 2, 1, 1, false, 0, 1, 1, 2
    void pMarch31osSprayBarrage(_side, _thickness, _iter, _delay, _extra, _delMult, _sizeMult, _skipEndDelay, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osSprayBarrage(_side, _thickness, _iter) --, 4, 2, 1, 1, false, 0, 1, 1, 2
    void pMarch31osOddAltBarrage(_side, _thickness, _iter, _delMult, _sizeMult, _barrageDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osOddAltBarrage(_side, _thickness, _iter) --, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osEvenAltBarrage(_side, _thickness, _iter, _delMult, _sizeMult, _barrageDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osEvenAltBarrage(_side, _thickness, _iter) --, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osAltHalfBarrage(_side, _thickness, _iter, _extraWalls, _delMult, _sizeMult, _barrageDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osAltHalfBarrage(_side, _thickness, _iter) --, 0, 1, 1, 0, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osAltTrapBarrage(_side, _thickness, _iter, _gap, _delMult, _sizeMult, _barrageDir, _offsetType, _offsetMult, _offsetDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osAltTrapBarrage(_side, _thickness, _iter) --, 1, 1, 1, getRandomDir(), 0, getRandomDir(), 1, false, false, 0, 1, 1, 2
    void pMarch31osCustomizedAltTrapBarrage(_side, _thickness, _iter, _sidedir1Neighbors, _sidedirmin1Gap, _delMult, _sizeMult, _barrageDir, _offsetType, _offsetMult, _offsetDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osCustomizedAltTrapBarrage(_side, _thickness, _iter) --, 0, 1, 1, 1, getRandomDir(), 0, getRandomDir(), 1, false, false, 0, 1, 1, 2

    void pMarch31osRandomWhirlwind(_side, _iter, _extra, _step, _pos_spacing, _delMult, _sizeMult, _direction, _slopeAmountStart, _slopeAmountEnd, _is_full, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osRandomWhirlwind(_side, _iter) --0, math.floor(getProtocolSides() / 3), 1, 1, 1, getRandomDir(), 0, false, false, 0, 1, 1, 2
    void pMarch31osFullWhirlwind(_side, _iter, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osFullWhirlwind(_side, _iter) --, 1, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osFullWhirlwindPrototype(_side, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osFullWhirlwindPrototype(_side) --, 1, getRandomDir(), false, false, 0, 1, 1, 2
    void pMarch31osZigZagSpiral(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _width, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    void pMarch31osZigZagSpiral(_side, _corridorThickNonSpd, _corridorThickSpd, _iter) --, 2, 1, 1, u_rndInt(0, 1), false, false, 0, 1, 1, 2

    void pMarch31osXer(_side, _skipEndDelay, _isRebootingSide, _endAdditionalDelay)
    void pMarch31osXer(_side) --, false, false, 0
    void pMarch31osGrowingBarrage(_side, _skipEndDelay, _isRebootingSide, _endAdditionalDelay)
    void pMarch31osGrowingBarrage(_side) --, false, false, 0
]]
...
function pMarch31osBarrageLeftRights(_side, _thickness, _iter, _gap, _distance, _isDelayDistance, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    pMarch31osBarrageTypeBase(_side, _thickness, _iter, _gap, 1, 1, anythingButNil(_distance, 1), _direction, false, (getBooleanNumber(_isDelayDistance) and (anythingButNil(_distance, 1) * 0.333 + 0.667) or 1) * _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
end
...
function pMarch31osWallDisplacer(_side, _thickness, _iter, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osDoubleBarrageSpiralAcross(_side, _thickness, _iter, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osAbstractBarrage(_side, _thickness, _iter, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    _iter = anythingButNil(_iter, u_rndInt(1, 3)); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
...
function pMarch31osWallExFillerSpiral(_side, _thickness, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osDoubleHoledBarrageSpiral(_side, _thickness, _iter, _extraHole, _delMult, _sizeMult, _distPosMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    pMarch31osBarrageTypeBase(_side, _thickness, anythingButNil(_iter, u_rndInt(4, 5)), 1, 2 + anythingButNil(_extraHole, 0), 0, anythingButNil(_distPosMult, 1), _direction, false, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
end

-- pMarch31osDoubleHoledBarrageLeftRights(): spawns a doubled hole barrage with left-right displacement
--   _extraHole: extra amount of holes
-- _distPosMult: displacement multiplier. default = 1
function pMarch31osDoubleHoledBarrageLeftRights(_side, _thickness, _iter, _extraHole, _delMult, _sizeMult, _distPosMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    pMarch31osBarrageTypeBase(_side, _thickness, anythingButNil(_iter, u_rndInt(4, 5)), 1, 2 + anythingButNil(_extraHole, 0), 1, anythingButNil(_distPosMult, 1), _direction, false, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
end
...
function pMarch31osDoubleHoledBarrageInversions(_side, _thickness, _iter, _extraHole, _isSpiral, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    pMarch31osBarrageTypeBase(_side, _thickness, anythingButNil(_iter, u_rndInt(4, 5)), 1, 2 + anythingButNil(_extraHole, 0), (getBooleanNumber(_isSpiral) and 0) or 2, (getBooleanNumber(_isSpiral) and math.floor(getProtocolSides() / 2)) or 1, _direction, false, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
end

-- pMarch31osCtoCIBarrage(): spawns one-holed barrage and double-holed barrage
function pMarch31osCtoCIBarrage(_side, _thickness, _iter, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osJumbleBarrage(_side, _thickness, _iter, _chance, _delMult, _sizeMult, _skipEndDelay, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osSprayBarrage(_side, _thickness, _iter, _delay, _extra, _delMult, _sizeMult, _skipEndDelay, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    _iter = anythingButNil(_iter, u_rndInt(3, 4)); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
...
function pMarch31osOddAltBarrage(_side, _thickness, _iter, _delMult, _sizeMult, _barrageDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    _iter = anythingButNil(_iter, u_rndInt(3, 4)); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
...
function pMarch31osEvenAltBarrage(_side, _thickness, _iter, _delMult, _sizeMult, _barrageDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    _iter = anythingButNil(_iter, u_rndInt(3, 4)); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    if _barrageDir == nil or _barrageDir == 0 then _barrageDir = getRandomDir(); end
    if _barrageDir < -1 then _barrageDir = -1 elseif _barrageDir > 1 then _barrageDir = 1; end
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
...
function pMarch31osAltHalfBarrage(_side, _thickness, _iter, _offset, _delMult, _sizeMult, _barrageDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osAltTrapBarrage(_side, _thickness, _iter, _gap, _delMult, _sizeMult, _barrageDir, _offsetType, _offsetMult, _offsetDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
-- _sidedir1Neighbors: barrage direction 1 neighbors. default = 0
--    _sidedirmin1Gap: barrage direction -1 gap, but extend. default = 1
--        _barrageDir: barrage direction
--        _offsetType: offset type. 0 = none, 1 = spiral, 2 = left-right, 3 = inversions
--        _offsetMult: offset multiplier
--         _offsetDir: offset direction
function pMarch31osCustomizedAltTrapBarrage(_side, _thickness, _iter, _sidedir1Neighbors, _sidedirmin1Gap, _delMult, _sizeMult, _barrageDir, _offsetType, _offsetMult, _offsetDir, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    _iter = anythingButNil(_iter, u_rndInt(3, 5)); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
...
function pMarch31osRandomWhirlwind(_side, _iter, _extra, _mirror_step, _pos_spacing, _seamless, _delMult, _sizeMult, _direction, _slopeAmountStart, _slopeAmountEnd, _is_full, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    if getProtocolSides() == 3 and ((_slopeAmountStart > 0 and _slopeAmountEnd > 0) and _is_full) then
        cBarrage(_curSide + _direction, customizePatternThickness(1 * p_setDelayPatternOfSpeedLessThan() * _sizeMult, p_getDelayPatternBool()));
        for i = 0, 2, 1 do
    ...
    elseif getProtocolSides() == 4 and ((_slopeAmountStart > 0 and _slopeAmountEnd > 0) and _is_full) then
        cWall(_curSide + _spiralPosistionOffset, customizePatternThickness(1 * currentSizeOverride * p_setDelayPatternOfSpeedLessThan() * _sizeMult, p_getDelayPatternBool())); _spiralPosistionOffset = _spiralPosistionOffset + _direction;
        for i = 0, 1 do cWall(_curSide + _spiralPosistionOffset + i * _direction, customizePatternThickness(5 * currentSizeOverride * p_setDelayPatternOfSpeedLessThan() * _sizeMult, p_getDelayPatternBool())); end _spiralPosistionOffset = _spiralPosistionOffset + _direction * 2;
        ...
        if (_slopeAmountStart > 0) then
            for fa = 0, _slopeAmountStart, 1 do
                for ia = 0, _slopeAmountStart - fa, 1 do
                    if ia > 0 then cWallMirrorEx(_curSide - (_direction * _pos_spacing * (ia - 1)), _step, _extra, customizePatternThickness(3 * p_setDelayPatternOfSpeedLessThan() * _delMult * _sizeMult, p_getDelayPatternBool())); end
                end
                cWallMirrorEx(_curSide + (_direction * _pos_spacing * fa) - (_slopeAmountStart * _direction * _pos_spacing), _step, _extra, customizePatternThickness(_curSpiralThick * p_setDelayPatternOfSpeedLessThan() * _delMult * _sizeMult, p_getDelayPatternBool()));
...
function pMarch31osFullWhirlwind(_side, _iter, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osZigZagSpiral(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _width, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    pMarch31osTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, anythingButNil(_iter, u_rndInt(3, 7)), 0, 2, 2, false, false, 0, 0, 1, 1, false, false, 0, 1, false, getBarrageSide(1 + anythingButNil(_width, 2)), nil, 0, nil, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
end
