--[[
    void pMarch31osAlternatingBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWalls, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce)
    void pMarch31osAlternatingBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 2, 1, false, 1, 1, u_rndInt(0, 1)
    void pMarch31osRandomBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWalls, _delMult, _delMult, _sizeMult)
    void pMarch31osRandomBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 2, 1, true, 1, 1
    void pMarch31osRandomBarrageNdistanceTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult)
    void pMarch31osRandomBarrageNdistanceTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 2, 1, false, 1, 1
    void pMarch31osJumbleTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWalls, _chance, _delMult, _sizeMult, _largeWallDesign, _isLargeWallOnce)
    void pMarch31osJumbleTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 2, 1, false, getProtocolSides() - 3, 1, 1
    void pMarch31osRandomizationLargeWallsTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallsDistanceMax, _isDistanceTight, _delMult, _sizeMult, _direction, _largeWallDesign)
    void pMarch31osRandomizationLargeWallsTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, u_rndIntUpper(getProtocolSides() - 2), true, 1, 1, getRandomDir()
    void pMarch31osTrapBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeGrowWalls, _growWallClawAdd, _growWallCapAdd, _delMult, _sizeMult, _direction)
    void pMarch31osTrapBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 2, 1, 1, 1, 1, 1, u_rndInt(0, 1)
    void pMarch31osBarrageSpiralTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _revFreq, _largeWalls, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce)
    void pMarch31osBarrageSpiralTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET) --, 0, 2, 1, false, 1, 1, getRandomDir()
    void pMarch31osDoubleBarrageSpiralAcrossTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeGrowWalls, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce)
    void pMarch31osDoubleBarrageSpiralAcrossTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 2, 1, false, 1, 1, getRandomDir()
    void pMarch31osLRTunnelShortSpiral(_side, _corridorThickOfSLT, _corridorThickOfSGET, _largeWalls, _isHardMode, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin)
    void pMarch31osLRTunnelShortSpiral(_side, _corridorThickOfSLT, _corridorThickOfSGET) --, 2, 1, false, false, 0, 1, 1, false, 1, 1, getRandomDir()
    void pMarch31osBackAndForthTunnelAxis(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _free, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd)
    void pMarch31osBackAndForthTunnelAxis(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 0, 2, 0, 0, 0, 0, false, (to be indexed if is nil), 1, 1, false, false, 0, 2, false, 1, 1, u_rndInt(0, 1)
    ...
    void pMarch31osBackAndForthTunnelAxisInterpolated(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 0, 2, 0, 0, 0, 0, false, (to be indexed if is nil), 1, 1, false, false, 0, 2, false, 1, 1, u_rndInt(0, 1)
    ...
    void pMarch31osBackAndForthTunnelCentral(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter) --, 0, 2, 0, 0, 0, 0, false, (to be indexed if is nil), 1, 1, false, false, 0, 2, false, 1, 1, u_rndInt(0, 1)
]]
...
local _constructDesignLargeGrowWallPart = function(_side, _largeWallDesign, _extra, _thickness)
    ...
    else                                        cGrowWall(_side, _extra, _thickness);
    end
end
...
function pMarch31osAlternatingBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWalls, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce)
    ...
    for a = 0, _iter, 1 do
        ...
        if a < _iter then
            ...
            cWallEx(_curSide + 1, _largeWalls - 1, p_getPatternThickness() * _sizeMult);
        end
...
function pMarch31osRandomBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWalls, _isRepeat, _isDelayDistance, _delMult, _sizeMult, _largeWallDesign)
...
function pMarch31osJumbleTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWalls, _chance, _delMult, _sizeMult, _largeWallDesign, _isLargeWallOnce)
    ...
    for a = 0, _iter, 1 do
        ...
        if a < _iter then
            ...
            cWallEx(_curSide, _largeWalls - 1, p_getPatternThickness() * _sizeMult);
        end
...
--       _isDelayDistance: is random barrage pattern has distance in it?
function pMarch31osRandomizationLargeWallsTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallsDistanceMax, _isDistanceTight, _delMult, _sizeMult, _direction, _largeWallDesign)
...
--  _largeGrowWalls: same as <_largeWalls> with cGrowWall
-- _growWallClawAdd: amount of extra arm claw
--  _growWallCapAdd: amount of extra cap
function pMarch31osTrapBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeGrowWalls, _growWallClawAdd, _growWallCapAdd, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce)
    ...
    for a = 0, _iter, 1 do
        ...
        elseif a == _iter then
            cGrowWall(_curSide, _largeGrowWalls - 1, p_getPatternThickness() * _sizeMult);
        end
        ...
        if (a + _tunnelLoopDir) % 2 == 1 then
            if _largeWallDesign == 2 and (a > 0 and a < _iter) then
                ...
                cGrowWall(_curSide, _growWallClawAdd + (_largeGrowWalls - 1), p_getPatternThickness() * _sizeMult);
            end
        else
            if _largeWallDesign == 1 and (a + _tunnelLoopDir) % 2 == 0 then cGrowWall(_curSide, _largeGrowWallExtra, p_getPatternThickness() * _sizeMult); end
            if getProtocolSides() % 2 == 1 then
                ...
                cGrowWall(_curSide + math.floor(getProtocolSides() / 2), _growWallCapAdd, p_getPatternThickness() * _sizeMult);
            end
        end
...
function pMarch31osBarrageSpiralTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _revFreq, _largeWalls, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce)
    ...
    for r = 0, _revFreq, 1 do
        ...
        for a = 1, getProtocolSides() - (_largeWalls + _amountOfRevFreqUntilEnd), 1 do
            ...
            if _largeWallDesign == 2 and (a > _amountOfRevFreqUntilEnd and a < getProtocolSides() - _largeWalls) then
                ...
                cBarrage(_curSide + _tunnelOffset, p_getPatternThickness() * _sizeMult);
            end
...
-- _largeGrowWalls: same as <_largeWalls> with cGrowWall
function pMarch31osDoubleBarrageSpiralAcrossTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeGrowWalls, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce)
    ...
    for a = 0, (math.floor(getProtocolSides() / 2) * _iter) - _iter - ((_largeGrowWalls - 1) * _iter), 1 do
        ...
        else cDoubleHoledBarrage(_curSide - (_tunnelOffset / 2), _tunnelOffset, 0, p_getPatternThickness() * _sizeMult);
        end
...
function pMarch31osLRTunnelShortSpiral(_side, _corridorThickOfSLT, _corridorThickOfSGET, _largeWalls, _isHardMode, _delMult, _sizeMult, _direction, _largeWallDesign, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin)
    ...
    local _constructLRTunShoSpiPart = function(_side, _extra, _gearTeethStepDir)
        if _gearTeethSizeMult > 0 then cTknsWall(_side, _gearTeethStepDel, _gearTeethStepLimit, _extra, _gearTeethStepDir, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult);
    ...
    for a = 0, _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd, 1 do
        ...
        if _modeDesign == 1 then
            ...
            for repeatAmount = 0, _repeatCorridorAmount, 1 do
                ...
                if _gearTeethSizeMult > 0 then
                    cTknsWall(_curSide + (((a + _tunnelLoopDir) % 2) * (2 + _free)) + _modeDesign1_offset, _gearTeethStepDel, _gearTeethStepLimit, _modeDesign1_adjust + 1 - _free, _tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult)
                    cTknsWall(_curSide - (((a + _tunnelLoopDir) % 2) * (2 + _free)) - (1 + _free + _modeDesign1_adjust), _gearTeethStepDel, _gearTeethStepLimit, _modeDesign1_adjust + 1 - _free, -_tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult)
                else
        ...
        elseif _modeDesign == 3 then
            ...
            for repeatAmount = 0, _repeatCorridorAmount, 1 do
                ...
                if _gearTeethSizeMult > 0 then
                    cTknsWall(_curSide + (((a + _tunnelLoopDir) % 2) * (2 + _free)), _gearTeethStepDel, _gearTeethStepLimit, math.ceil(getProtocolSides() / 2) - (_free + 2), _tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult)
                    cTknsWall(_curSide - (((a + _tunnelLoopDir) % 2) * (2 + _free)) + getHalfSides() + (2 + _free), _gearTeethStepDel, _gearTeethStepLimit, math.ceil(getProtocolSides() / 2) - (2 + (getProtocolSides() % 2)) - _free, -_tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult)
        ...
        if _modeDesign == 1 then
            ...
            for repeatAmount = 0, _repeatCorridorAmount, 1 do
                ...
                if _gearTeethSizeMult > 0 then
                    cTknsWall(_curSide + (((a + _tunnelLoopDir) % 2) * (2 + _free)), _gearTeethStepDel, _gearTeethStepLimit, math.ceil(getProtocolSides() / 2) - (_free + 2), _tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult)
                    cTknsWall(_curSide - (((a + _tunnelLoopDir) % 2) * (2 + _free)) + getHalfSides() + (2 + _free), _gearTeethStepDel, _gearTeethStepLimit, math.ceil(getProtocolSides() / 2) - (2 + (getProtocolSides() % 2)) - _free, -_tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult)
                else cDrawWall(_curSide + (((a + _tunnelLoopDir + 1) % 2) * getHalfSides()), 2 + _free, getProtocolSides() - (2 + _free), p_getPatternThickness() * _saveOldGearTeethSizeMult * _sizeMult);
                end
                if repeatAmount < _repeatCorridorAmount then t_applyPatDel(customizePatternDelay(_repeatCorridorDelay * _sizeMult, _isRepeatCorridorDelaySpd)); end
            end
            if (not getBooleanNumber(_isLargeWallOnce)) then
    ...
    for a = 0, _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd, 1 do
        ...
        if _modeDesign == 1 then
            ...
            for repeatAmount = 0, _repeatCorridorAmount, 1 do
                ...
                if _gearTeethSizeMult > 0 then
                    cTknsWall(_curSide + (((a + _tunnelLoopDir) % 2) * (2 + _free)) + _modeDesign1_offset, _gearTeethStepDel, _gearTeethStepLimit, _modeDesign1_adjust + 1, _tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult);
                    cTknsWall(_curSide + (((a + _tunnelLoopDir) % 2) * (2 + _free)) - (3 + _modeDesign1_adjust), _gearTeethStepDel, _gearTeethStepLimit, _modeDesign1_adjust + 1, _tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult);
                else
        ...
        elseif _modeDesign == 3 then
            ...
            for repeatAmount = 0, _repeatCorridorAmount, 1 do
                ...
                if _gearTeethSizeMult > 0 then
                    cTknsWall(_curSide + (((a + _tunnelLoopDir) % 2) * (2 + _free)), _gearTeethStepDel, _gearTeethStepLimit, math.ceil(getProtocolSides() / 2) - (_free + 2), _tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult)
                    cTknsWall(_curSide + (((a + _tunnelLoopDir) % 2) * (2 + _free)) + getHalfSides(), _gearTeethStepDel, _gearTeethStepLimit, math.ceil(getProtocolSides() / 2) - (2 + (getProtocolSides() % 2)) - _free, _tunnelLoopDirGearTeeth, _gearTeethInc * _gearTeethSizeMult, p_getPatternThickness() * _gearTeethSizeMult * _sizeMult)
