--[[
    ...
    void pMarch31osRandomWhirlwind(_side, _iter, _extra, _mirror_step, _pos_spacing, _delMult, _sizeMult, _direction, _slopeAmountStart, _slopeAmountEnd, _is_full, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
