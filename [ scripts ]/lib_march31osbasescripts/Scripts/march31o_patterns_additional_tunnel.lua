...
--[[
    void pMarch31osAlternatingBarrageTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osRandomBarrageTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWalls, _delMult, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osRandomBarrageNdistanceTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osJumbleTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWalls, _isLargeWallOnce, _chance, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osRandomizationLargeWallsTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWallsDistanceMax, _isDistanceTight, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osTrapBarrageTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeGrowWalls, _growWallClawAdd, _growWallCapAdd, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osBarrageSpiralTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _revFreq, _designType, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osDoubleBarrageSpiralAcrossTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeGrowWalls, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osLRTunnelShortSpiral(_side, _corridorThickNonSpd, _corridorThickSpd, _designType, _largeWalls, _isLargeWallOnce, _isHardMode, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osBackAndForthTunnelAxis(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _free, _designType, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osBackAndForthTunnelAxisInterpolated(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _free, _designType, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void pMarch31osBackAndForthTunnelCentral(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _free, _designType, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
...
local _constructBAFTunnelLargeWallPart = function(_side, _freqAmount, _freqCount, _largeWallThick, _corridorThick, _isLargeWallThickSpdMode, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _sizeMult, _designType)
    ...
    if (getProtocolSides() % 3 > 0) then
        if (_designType <= 1) then
            ...
            if (_designType == 0 and getProtocolSides() % 3 == 2) and _freqCount == 0 then cWall(_side - 1, _corridorThick * _sizeMult); end
            if (_designType == 1 and getProtocolSides() % 3 == 2) then cWall(_side - 1, _corridorThick * _sizeMult); end
        else
...
function pMarch31osAlternatingBarrageTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(3, 6)); _designType = anythingButNil(_designType, 2); _largeWalls = anythingButNil(_largeWalls, 1); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    ...
    p_adjustPatternDelaySettings(_spdIsGreaterThanEqual or 2, _delayMultSpdLessThan or 1, _corridorThickNonSpd or THICKNESS, _corridorThickSpd);
    ...
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide + 1, _designType, _largeWalls - 1, customizePatternThickness(3.9 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
    end
    ...
    for a = 0, _iter, 1 do
        ...
        if a < _iter then
            if (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignCWallExPart(_curSide + 1, _designType, _largeWalls - 1, customizePatternThickness(3.9 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
            if (_designType == 1 and _largeWalls > 1) or (_designType < 1 and a == 0) then cWallEx(_curSide + 1, _largeWalls - 1, p_getPatternThickness() * _sizeMult); end
        ...
        t_applyPatDel(customizePatternDelay(3.9 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()));
    end
...
function pMarch31osRandomBarrageTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWalls, _isRepeat, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(2, 5)); _designType = anythingButNil(_designType, 2); _largeWalls = anythingButNil(_largeWalls, 1); _isRepeat = anythingButNil(_isRepeat, 1); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
    ...
    for a = 0, _iter, 1 do
        ...
        _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness((3 * (6 / getProtocolSides()) * p_setDelayPatternOfSpeedLessThan()) * _curDelaySpeed * _delMult * _sizeMult * (_tunnelDistanceDelay / 1.25) + 1.25, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
        t_applyPatDel(customizePatternDelay((3 * (6 / getProtocolSides()) * p_setDelayPatternOfSpeedLessThan()) * _curDelaySpeed * _delMult * _sizeMult * (_tunnelDistanceDelay / 1.25) + 1.25, p_getDelayPatternBool()));
    end
...
function pMarch31osRandomBarrageNdistanceTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(3, 6)); _designType = anythingButNil(_designType, 2); _largeWalls = anythingButNil(_largeWalls, 1); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
    ...
    --for larger wall once 
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness(5 * ((getProtocolSides() / 9) + 0.75) * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
    end

    for a = 0, _iter, 1 do
        if a < _iter then
            if (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness(5 * ((getProtocolSides() / 9) + 0.75) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
        end
        if _designType == 0 and (a > 0 and a < _iter) then
            _randomizeSidePosFix = u_rndInt(0, getProtocolSides() - (_largeWalls + 1));
            for i = _largeWalls, getProtocolSides(), 1 do
                if i ~= _largeWalls + _randomizeSidePosFix then cWall(_curSide + i, p_getPatternThickness() * _sizeMult); end
            end
        else cBarrage(_curSide + u_rndInt(_largeWalls, getProtocolSides() - 1), p_getPatternThickness() * _sizeMult);
        end
        if a < _iter then t_applyPatDel(customizePatternDelay(5 * ((getProtocolSides() / 9) + 0.75) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool())); end
    end
...
function pMarch31osJumbleTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWalls, _isLargeWallOnce, _chance, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(3, 4)); _designType = anythingButNil(_designType, 2); _chance = anythingButNil(_chance, getProtocolSides() - 4); _largeWalls = anythingButNil(_largeWalls, 1); _delMult = anythingButNil(_delMult, 1.4); _sizeMult = anythingButNil(_sizeMult, 1);
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
    ...
    --for larger wall once 
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness(2.75 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
    end
    ...
    for a = 0, _iter, 1 do
        ...
        if a < _iter then
            if (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness(2.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
        else cWallEx(_curSide, _largeWalls - 1, p_getPatternThickness() * _sizeMult);
        end

        if _designType == 0 and a == 0 then cWallEx(_curSide, _largeWalls - 1, p_getPatternThickness() * _sizeMult);
        elseif _designType > 0 and a < _iter then cWallEx(_curSide, _largeWalls - 1, p_getPatternThickness() * _sizeMult);
        end

        for c = 1, _chance, 1 do cWall(_curSide + u_rndInt(_largeWalls, getProtocolSides() - 1), p_getPatternThickness() * _sizeMult); end

        t_applyPatDel(customizePatternDelay(2.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()));
    end
...
function pMarch31osRandomizationLargeWallsTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeWallsDistanceMax, _isDistanceTight, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(3, 4)); _designType = anythingButNil(_designType, 2); _largeWallsDistanceMax = anythingButNil(_largeWallsDistanceMax, getProtocolSides() - 2); _isDistanceTight = anythingButNil(_isDistanceTight, 1); _delMult = anythingButNil(_delMult, 1.4); _sizeMult = anythingButNil(_sizeMult, 1);
    if not _loopDir or _loopDir > 1 or _loopDir < -1 or _loopDir == 0 then _loopDir = getRandomDir(); end
    ...
    for a = 0, _iter, 1 do
        ...
        if a < _iter then
            if _designType <= 1 then
                cWall(_curSide + 1 * -_tunnelLoopDir + _tunnelOffset, customizePatternThickness(_curTunnelDel * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult * (_amountCurDistanceActivate), p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
                cWall(_curSide + ((getProtocolSides() - 1) - _tunnelDistance) * -_tunnelLoopDir + _tunnelOffset, customizePatternThickness(_curTunnelDel * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult * (_amountCurDistanceActivate), p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
            else
                for i = 1, (getProtocolSides() - 1) - _tunnelDistance, 1 do cWall(_curSide + i * -_tunnelLoopDir + _tunnelOffset, customizePatternThickness(_curTunnelDel * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult * (_amountCurDistanceActivate), p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
            end
            t_applyPatDel(customizePatternDelay(_curTunnelDel * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult * (_amountCurDistanceActivate), p_getDelayPatternBool()));
...
function pMarch31osTrapBarrageTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeGrowWalls, _growWallClawAdd, _growWallCapAdd, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(3, 6)); _designType = anythingButNil(_designType, 2); _largeGrowWalls = anythingButNil(_largeGrowWalls, 1); _delMult = anythingButNil(_delMult, 1.4); _sizeMult = anythingButNil(_sizeMult, 1);
    ...
    --for larger wall once 
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide, _designType, _largeGrowWalls - 1, customizePatternThickness(4.75 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, myResultBool) + ((p_getPatternThickness() / 2) * _sizeMult))
    end

    for a = 0, _iter, 1 do
        p_patternEffectCycle(_curSide, _designType, _largeGrowWalls - 1, customizePatternThickness(4.75 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, myResultBool) + ((p_getPatternThickness() / 2) * _sizeMult));

        if a < _iter then
			if (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignLargGrowWallPart(_curSide, _designType, _largeGrowWalls - 1, customizePatternThickness(4.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, myResultBool) + ((p_getPatternThickness() / 2) * _sizeMult)); end
        ...
        if (a + _tunnelLoopDir) % 2 == 1 then
            ...
            if _designType == 1 and (a + _tunnelLoopDir) % 2 == 0 then cWallGrow(_curSide, _largeGrowWallExtra, p_getPatternThickness() * _sizeMult); end
        ...
        t_applyPatDel(customizePatternDelay(4.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, myResultBool));
    end
...
function pMarch31osBarrageSpiralTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _revFreq, _designType, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _revFreq = anythingButNil(_revFreq, 0); _designType = anythingButNil(_designType, 1); _largeWalls = anythingButNil(_largeWalls, 1); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    if not _loopDir or _loopDir > 1 or _loopDir < -1 or _loopDir == 0 then _loopDir = getRandomDir(); end
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
    ...
    for r = 0, _revFreq, 1 do
        ...
        if (getBooleanNumber(_isLargeWallOnce)) and r == 0 then
            _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness(4.75 * (getProtocolSides() - (_largeWalls + _amountOfRevFreqUntilEnd)) * (_revFreq + 1) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
        end
        ...
        for a = 1, getProtocolSides() - (_largeWalls + _amountOfRevFreqUntilEnd), 1 do
            ...
            if a < getProtocolSides() - _largeWalls and (not getBooleanNumber(_isLargeWallOnce)) then
                _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness(4.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
            end
            ...
            t_applyPatDel(customizePatternDelay(4.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()));
...
function pMarch31osDoubleBarrageSpiralAcrossTunnel(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _designType, _largeGrowWalls, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(1, 4)); _designType = anythingButNil(_designType, 2); _largeGrowWalls = anythingButNil(_largeGrowWalls, 1); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    if not _loopDir or _loopDir > 1 or _loopDir < -1 or _loopDir == 0 then _loopDir = getRandomDir(); end
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
    ...
    --for larger wall once 
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide, _designType, _largeGrowWalls - 1, customizePatternThickness(3.6 * ((math.floor(getProtocolSides() / 2) * _iter) - _iter - ((_largeGrowWalls - 1) * _iter)) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
    end

    for a = 0, (math.floor(getProtocolSides() / 2) * _iter) - _iter - ((_largeGrowWalls - 1) * _iter), 1 do
        p_patternEffectCycle();
        if a < (math.floor(getProtocolSides() / 2) * _iter) - _iter - ((_largeGrowWalls - 1) * _iter) and (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignLargGrowWallPart(_curSide, _designType, _largeGrowWalls - 1, customizePatternThickness(3.6 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
        ...
        t_applyPatDel(customizePatternDelay(3.6 * p_setDelayPatternOfSpeedLessThan() * _delMult * _curDelaySpeed, p_getDelayPatternBool()))
    end
...
function pMarch31osLRTunnelShortSpiral(_side, _corridorThickNonSpd, _corridorThickSpd, _designType, _largeWalls, _isLargeWallOnce, _isHardMode, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _designType = anythingButNil(_designType, 2); _largeWalls = anythingButNil(_largeWalls, 1); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    if not _loopDir or _loopDir > 1 or _loopDir < -1 or _loopDir == 0 then _loopDir = getRandomDir(); end
    ...
    for a = 2, getProtocolSides() - (_largeWalls + 1), 1 do
        ...
        --for larger wall once 
        if (getBooleanNumber(_isLargeWallOnce)) then
            if a == 2 then _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness((4.75 * ((getProtocolSides() * 2) - (_largeWalls + 5 + _isHardMode))) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _saveOldGearTeethSizeMult * _sizeMult)); end
        else
            _constructDesignCWallExPart(_curSide, _designType, _largeWalls - 1, customizePatternThickness((a < getProtocolSides() - (_largeWalls) - _isHardMode and 9.5 or 4.75) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _saveOldGearTeethSizeMult * _sizeMult));
        end
...
function pMarch31osBackAndForthTunnelAxis(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _free, _designType, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(4, 6)); _designType = anythingButNil(_designType, 2); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    ...
    for a = 0, _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd, 1 do
        ...
        if _modeDesign == 1 then
            if (getBooleanNumber(_isLargeWallOnce) and a == 0) then
                _constructDesignCWallExPart(_curSide, _designType, _modeDesign1_offset, customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
                _constructDesignCWallExPart(_curSide + 3 + _modeDesign1_offset + _modeDesign1_adjust, _designType, getProtocolSides() - 3 - _modeDesign1_adjust - (3 + _modeDesign1_offset + _modeDesign1_adjust), customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
            end

            for repeatAmount = 0, _repeatCorridorAmount, 1 do
                if repeatAmount < _repeatCorridorAmount then
                    _constructDesignCWallExPart(_curSide, _designType, _modeDesign1_offset, customizePatternThickness(_repeatCorridorDelay * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
                    _constructDesignCWallExPart(_curSide + 3 + _modeDesign1_offset + _modeDesign1_adjust, _designType, getProtocolSides() - 3 - _modeDesign1_adjust - (3 + _modeDesign1_offset + _modeDesign1_adjust), customizePatternThickness(_repeatCorridorDelay * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
                end
            ...
            if a < _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd then
                if (not getBooleanNumber(_isLargeWallOnce)) then
                    _constructDesignCWallExPart(_curSide, _designType, _modeDesign1_offset, customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
                    _constructDesignCWallExPart(_curSide + 3 + _modeDesign1_offset + _modeDesign1_adjust, _designType, getProtocolSides() - 3 - _modeDesign1_adjust - (3 + _modeDesign1_offset + _modeDesign1_adjust), customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
                end
        ...
        elseif _modeDesign == 2 then
            if (getBooleanNumber(_isLargeWallOnce) and a == 0) then
                _constructBAFTunnelLargeWallPart(_curSide, (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd), a, 4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult, p_getPatternThickness(), p_getDelayPatternBool(), _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _sizeMult, _designType);
            end

            for repeatAmount = 0, _repeatCorridorAmount, 1 do
                if repeatAmount < _repeatCorridorAmount then _constructBAFTunnelLargeWallPart(_curSide, _repeatCorridorDelay, p_getPatternThickness(), _isRepeatCorridorDelaySpd, _sizeMult, _designType); end
            ...
            if a < _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd then
                if (not getBooleanNumber(_isLargeWallOnce)) then
                    _constructBAFTunnelLargeWallPart(_curSide, (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd), a, 4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult, p_getPatternThickness(), p_getDelayPatternBool(), _sizeMult, _designType);
                end
            else
        ...
        elseif _modeDesign == 3 then
            if (getBooleanNumber(_isLargeWallOnce) and a == 0) then
                for i = 0, 1, 1 do cWall(_curSide + (i * (closeValue(getProtocolSides() % 3, 0, 1) + 3)), customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult)); end
                if getProtocolSides() >= 9 then
                    for i = 0, math.floor(getProtocolSides() / 3) - 3, 1 do cWall(_curSide + (i * 3) + (closeValue(getProtocolSides() % 3, 0, 1) + closeValue((getProtocolSides() % 3) - 1, 0, 1) + 6), customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult)); end
                end
            end
            ...
            if a < _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd then
                if (not getBooleanNumber(_isLargeWallOnce)) then 
                    for i = 0, 1, 1 do cWall(_curSide + (i * (closeValue(getProtocolSides() % 3, 0, 1) + 3)), customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
                    if getProtocolSides() >= 9 then
                        for i = 0, math.floor(getProtocolSides() / 3) - 3, 1 do cWall(_curSide + (i * 3) + (closeValue(getProtocolSides() % 3, 0, 1) + closeValue((getProtocolSides() % 3) - 1, 0, 1) + 6), customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
                    end
                end
            else
            ...
            if (getBooleanNumber(_isLargeWallOnce) and a == 0) then rWall(_curSide, customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult)); end
            for repeatAmount = 0, _repeatCorridorAmount, 1 do
            ...
            if (a < _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd and not getBooleanNumber(_isLargeWallOnce)) then rWall(_curSide, customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
        end

        _tunnelLoopDirGearTeeth = _tunnelLoopDirGearTeeth * -1
        if (_isBeforeGearTeethBegin) and _amountOfBeforeGearTeethBegin == 0 and _gearTeethSizeMult == 0 then _amountOfBeforeGearTeethBegin = _amountOfBeforeGearTeethBegin + 1; _gearTeethSizeMult = _oldGearTeethSizeMult; end
        t_applyPatDel(customizePatternDelay(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()));
    end
...
function pMarch31osBackAndForthTunnelAxisInterpolated(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _free, _designType, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    for a = 0, _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd, 1 do
        ...
        if _modeDesign == 1 then
            ...
            if (not getBooleanNumber(_isLargeWallOnce)) then
                if a < (math.floor((_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * 0.5) * 2) then cWall(_curSide + (((_tunnelLoopDir) % 2) * getHalfSides()), customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
                if a > 0 and a < (math.floor((_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * 0.5 - 0.5) * 2) + 1 then cWall(_curSide + (((_tunnelLoopDir + 1) % 2) * getHalfSides()), customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
            end
        end
...
function pMarch31osBackAndForthTunnelCentral(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _free, _designType, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    _iter = anythingButNil(_iter, u_rndInt(4, 6)); _designType = anythingButNil(_designType, 2); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    _free = anythingButNil(_free, 0); _modeDesign = anythingButNil(_modeDesign, 0); _modeDesign1_offset = anythingButNil(_modeDesign1_offset, 0); _modeDesign1_adjust = anythingButNil(_modeDesign1_adjust, 0);
    if not _loopDir or _loopDir > 1 or _loopDir < 0 then _loopDir = u_rndInt(0, 1); end
    _gearTeethSizeMult = anythingButNil(_gearTeethSizeMult, 0); _isBeforeGearTeethBegin = anythingButNil(_isBeforeGearTeethBegin, 0); _isAfterGearTeethEnd = anythingButNil(_isAfterGearTeethEnd, 0);
    ...
    for a = 0, _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd, 1 do
        ...
        if _modeDesign == 1 then
            if (getBooleanNumber(_isLargeWallOnce) and a == 0) then
                _constructDesignCWallExPart(_curSide, _designType, _modeDesign1_offset, customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
                _constructDesignCWallExPart(_curSide + 3 + _modeDesign1_offset + _modeDesign1_adjust, _designType, getProtocolSides() - 3 - _modeDesign1_adjust - (3 + _modeDesign1_offset + _modeDesign1_adjust), customizePatternThickness(4.5 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
            end
        ...
        elseif _modeDesign == 2 then
            ...
            for repeatAmount = 0, _repeatCorridorAmount, 1 do
                if repeatAmount < _repeatCorridorAmount and (not getBooleanNumber(_isLargeWallOnce)) then _constructBAFTunnelLargeWallPart(_curSide, (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd), a, _repeatCorridorDelay, p_getPatternThickness(), _isRepeatCorridorDelaySpd, _sizeMult, _designType); end
