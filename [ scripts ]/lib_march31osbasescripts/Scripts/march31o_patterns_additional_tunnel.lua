--[[
    void pMarch31osAlternatingBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    void pMarch31osJumbleTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWalls, _isLargeWallOnce, _chance, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    void pMarch31osRandomizationLargeWallsTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWallsDistanceMax, _isDistanceTight, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    void pMarch31osBarrageSpiralTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _revFreq, _largeWallDesign, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    void pMarch31osDoubleBarrageSpiralAcrossTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeGrowWalls, _isLargeWallOnce, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    void pMarch31osLRTunnelShortSpiral(_side, _corridorThickOfSLT, _corridorThickOfSGET, _largeWallDesign, _largeWalls, _isLargeWallOnce, _isHardMode, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    void pMarch31osBackAndForthTunnelAxis(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _free, _largeWallDesign, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    void pMarch31osBackAndForthTunnelAxisInterpolated(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _free, _largeWallDesign, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    void pMarch31osBackAndForthTunnelCentral(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _free, _largeWallDesign, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osAlternatingBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    _iter = anythingButNil(_iter, u_rndInt(3, 6)); _largeWallDesign = anythingButNil(_largeWallDesign, 2); _largeWalls = anythingButNil(_largeWalls, 1); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    ...
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide + 1, _largeWallDesign, _largeWalls - 1, customizePatternThickness(3.9 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
    end
    ...
    for a = 0, _iter, 1 do
        ...
        if a < _iter then
            if (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignCWallExPart(_curSide + 1, _largeWallDesign, _largeWalls - 1, customizePatternThickness(3.9 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
...
function pMarch31osRandomBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWalls, _isRepeat, _isDelayDistance, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    if (getBooleanNumber(_isLargeWallOnce) and not getBooleanNumber(_isDelayDistance)) then
        _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness(5 * ((getProtocolSides() / 9) + 0.75) * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
    end
    ...
    for a = 0, _iter, 1 do
        ...
        if getBooleanNumber(_isDelayDistance) then
            _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness((3 * (6 / getProtocolSides()) * p_setDelayPatternOfSpeedLessThan()) * _curDelaySpeed * _delMult * _sizeMult * (_tunnelDistanceDelay / 1.25) + 1.25, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
            ...
            if (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness(5 * ((getProtocolSides() / 9) + 0.75) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
            t_applyPatDel(customizePatternDelay(5 * ((getProtocolSides() / 9) + 0.75) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()));
        end
    end
...
function pMarch31osRandomBarrageNdistanceTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    _iter = anythingButNil(_iter, u_rndInt(3, 6)); _largeWallDesign = anythingButNil(_largeWallDesign, 2); _largeWalls = anythingButNil(_largeWalls, 1); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    _isTight = anythingButNil(_isTight, 0); _skipEndDelay = anythingButNil(_skipEndDelay, 0);
...
function pMarch31osJumbleTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWalls, _isLargeWallOnce, _chance, _delMult, _sizeMult, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    --for larger wall once 
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness(2.75 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
    end
    ...
    for a = 0, _iter, 1 do
        ...
        if a < _iter then
            if (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness(2.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
...
--       _isDelayDistance: is random barrage pattern has distance in it?
function pMarch31osRandomizationLargeWallsTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeWallsDistanceMax, _isDistanceTight, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
...
function pMarch31osTrapBarrageTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeGrowWalls, _growWallClawAdd, _growWallCapAdd, _isLargeWallOnce, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    --for larger wall once 
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeGrowWalls - 1, customizePatternThickness(4.75 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, myResultBool) + ((p_getPatternThickness() / 2) * _sizeMult))
    end

    for a = 0, _iter, 1 do
        p_patternEffectCycle(_curSide, _largeWallDesign, _largeGrowWalls - 1, customizePatternThickness(4.75 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, myResultBool) + ((p_getPatternThickness() / 2) * _sizeMult));

        if a < _iter then
            if (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignLargeGrowWallPart(_curSide, _largeWallDesign, _largeGrowWalls - 1, customizePatternThickness(4.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, myResultBool) + ((p_getPatternThickness() / 2) * _sizeMult)); end
...
function pMarch31osBarrageSpiralTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _revFreq, _largeWallDesign, _largeWalls, _isLargeWallOnce, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    for r = 0, _revFreq, 1 do
        ...
        if (getBooleanNumber(_isLargeWallOnce)) and r == 0 then
            _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness(4.75 * (getProtocolSides() - (_largeWalls + _amountOfRevFreqUntilEnd)) * (_revFreq + 1) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
        end
        ...
        for a = 1, getProtocolSides() - (_largeWalls + _amountOfRevFreqUntilEnd), 1 do
            ...
            if a < getProtocolSides() - _largeWalls and (not getBooleanNumber(_isLargeWallOnce)) then
                _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness(4.75 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
            end
...
-- _largeGrowWalls: same as <_largeWalls> with cWallGrow
function pMarch31osDoubleBarrageSpiralAcrossTunnel(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _largeWallDesign, _largeGrowWalls, _isLargeWallOnce, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    --for larger wall once 
    if (getBooleanNumber(_isLargeWallOnce)) then
        _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeGrowWalls - 1, customizePatternThickness(3.6 * ((math.floor(getProtocolSides() / 2) * _iter) - _iter - ((_largeGrowWalls - 1) * _iter)) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult))
    end

    for a = 0, (math.floor(getProtocolSides() / 2) * _iter) - _iter - ((_largeGrowWalls - 1) * _iter), 1 do
        p_patternEffectCycle();
        if a < (math.floor(getProtocolSides() / 2) * _iter) - _iter - ((_largeGrowWalls - 1) * _iter) and (not getBooleanNumber(_isLargeWallOnce)) then _constructDesignLargeGrowWallPart(_curSide, _largeWallDesign, _largeGrowWalls - 1, customizePatternThickness(3.6 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult)); end
...
function pMarch31osLRTunnelShortSpiral(_side, _corridorThickOfSLT, _corridorThickOfSGET, _largeWallDesign, _largeWalls, _isLargeWallOnce, _isHardMode, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    for a = 2, getProtocolSides() - (_largeWalls + 1), 1 do
        ...
        --for larger wall once 
        if (getBooleanNumber(_isLargeWallOnce)) then
            if a == 2 then _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness((4.75 * ((getProtocolSides() * 2) - (_largeWalls + 5 + _isHardMode))) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _saveOldGearTeethSizeMult * _sizeMult)); end
        else
            _constructDesignCWallExPart(_curSide, _largeWallDesign, _largeWalls - 1, customizePatternThickness((a < getProtocolSides() - (_largeWalls) - _isHardMode and 9.5 or 4.75) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _saveOldGearTeethSizeMult * _sizeMult));
        end
...
function pMarch31osBackAndForthTunnelAxis(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _free, _largeWallDesign, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    ...
    for a = 0, _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd, 1 do
        ...
        if _modeDesign == 1 then
            if (getBooleanNumber(_isLargeWallOnce) and a == 0) then
                _constructDesignCWallExPart(_curSide, _largeWallDesign, _modeDesign1_offset, customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
                _constructDesignCWallExPart(_curSide + 3 + _modeDesign1_offset + _modeDesign1_adjust, _largeWallDesign, getProtocolSides() - 3 - _modeDesign1_adjust - (3 + _modeDesign1_offset + _modeDesign1_adjust), customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
            end
            ...
            if a < _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd then
                if (not getBooleanNumber(_isLargeWallOnce)) then
                    _constructDesignCWallExPart(_curSide, _largeWallDesign, _modeDesign1_offset, customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
                    _constructDesignCWallExPart(_curSide + 3 + _modeDesign1_offset + _modeDesign1_adjust, _largeWallDesign, getProtocolSides() - 3 - _modeDesign1_adjust - (3 + _modeDesign1_offset + _modeDesign1_adjust), customizePatternThickness(4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + ((p_getPatternThickness() / 2) * _sizeMult));
                end
        ...
        elseif _modeDesign == 3 then
            ...
            if a < _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd then
                if (not getBooleanNumber(_isLargeWallOnce)) then
                    _constructBAFTunnelLargeWallPart(_curSide, (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd), a, 4.5 * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult, p_getPatternThickness(), p_getDelayPatternBool(), _sizeMult, _largeWallDesign);
                end
            else
...
-- _sidedir0offset: amount of offset of direction right. (default = 0)
-- _sidedir1offset: amount of offset of direction left. (default = 0)
function pMarch31osBackAndForthTunnelCentral(_side, _corridorThickOfSLT, _corridorThickOfSGET, _iter, _free, _largeWallDesign, _modeDesign, _modeDesign1_offset, _modeDesign1_adjust, _isLargeWallOnce, _gearTeethSizeMult, _gearTeethInc, _gearTeethStepDel, _gearTeethStepLimit, _isBeforeGearTeethBegin, _isAfterGearTeethEnd, _repeatCorridorAmount, _repeatCorridorDelay, _isRepeatCorridorDelaySpd, _delMult, _sizeMult, _direction, _skipEndDelay, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual)
    _iter = anythingButNil(_iter, u_rndInt(4, 6)); _largeWallDesign = anythingButNil(_largeWallDesign, 2); _delMult = anythingButNil(_delMult, 1); _sizeMult = anythingButNil(_sizeMult, 1);
    _free = anythingButNil(_free, 0); _modeDesign = anythingButNil(_modeDesign, 0); _modeDesign1_offset = anythingButNil(_modeDesign1_offset, 0); _modeDesign1_adjust = anythingButNil(_modeDesign1_adjust, 0);
    if not _direction or _direction > 1 or _direction < 0 then _direction = u_rndInt(0, 1); end
    _gearTeethSizeMult = anythingButNil(_gearTeethSizeMult, 0); _isBeforeGearTeethBegin = anythingButNil(_isBeforeGearTeethBegin, 0); _isAfterGearTeethEnd = anythingButNil(_isAfterGearTeethEnd, 0);
    ...
    for a = 0, _iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd, 1 do
        ...
        if _modeDesign == 1 then
            if (getBooleanNumber(_isLargeWallOnce) and a == 0) then
                _constructDesignCWallExPart(_curSide, _largeWallDesign, _modeDesign1_offset, customizePatternThickness(4.5 * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd) * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
                _constructDesignCWallExPart(_curSide + 3 + _modeDesign1_offset + _modeDesign1_adjust, _largeWallDesign, getProtocolSides() - 3 - _modeDesign1_adjust - (3 + _modeDesign1_offset + _modeDesign1_adjust), customizePatternThickness(4.5 * _iter * p_setDelayPatternOfSpeedLessThan() * _curDelaySpeed * _delMult * _sizeMult, p_getDelayPatternBool()) + customizePatternThickness(_repeatCorridorDelay * (_repeatCorridorAmount + (_repeatCorridorAmount * (_iter + _timesOfBeforeGearTeethBegin + _timesOfAfterGearTeethEnd))) * _sizeMult, _isRepeatCorridorDelaySpd) + ((p_getPatternThickness() / 2) * _sizeMult));
            end
