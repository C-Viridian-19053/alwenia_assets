...
--[[
    void fMarch31osSwapBarrage(_side, _corridorThickNonSpd, _corridorThickSpd, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    void fMarch31osSwapBarrage(_side, _corridorThickNonSpd, _corridorThickSpd) --, 1, 1, false, 0, 1, 1, 2, false, false
    void fMarch31osSwapCorridor(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    void fMarch31osSwapCorridor(_side, _corridorThickNonSpd, _corridorThickSpd, _iter) --, 1, 1, false, 0, 1, 1, 2, false, false
    void fMarch31osChance(_side, _corridorThickNonSpd, _corridorThickSpd, _delMult, _sizeMult, _blockDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    void fMarch31osChance(_side, _corridorThickNonSpd, _corridorThickSpd) --, 1, 1, getRandomDir(), false, 0, 1, 1, 2, false, false
    void fMarch31osBarrageNoDelay(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _delMult, _sizeMult, _loopDir, _isRandDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void fMarch31osMirrorWhirlwind(_side, _thickness, _iter, _extra, _pos_spacing, _seamless, _delMult, _sizeMult, _loopDir, _blockDir, _is_clean, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
    ...
    void fMarch31osSwapTunnelCorridor(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
...
function fMarch31osSwapBarrage(_side, _corridorThickNonSpd, _corridorThickSpd, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
...
function fMarch31osSwapCorridor(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _delMult, _sizeMult, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
...
function fMarch31osChance(_side, _corridorThickNonSpd, _corridorThickSpd, _delMult, _sizeMult, _blockDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
...
function fMarch31osBarrageNoDelay(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _delMult, _sizeMult, _loopDir, _isRandDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
...
function fMarch31osMirrorWhirlwind(_side, _thickness, _iter, _extra, _pos_spacing, _seamless, _delMult, _sizeMult, _loopDir, _blockDir, _isCleanStart, _isCleanEnd, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
...
function fMarch31osSwapTunnelCorridor(_side, _corridorThickNonSpd, _corridorThickSpd, _iter, _isLargeWallOnce, _delMult, _sizeMult, _loopDir, _isRebootingSide, _endAdditionalDelay, _addMult, _delayMultSpdLessThan, _spdIsGreaterThanEqual, _isTight, _skipEndDelay)
