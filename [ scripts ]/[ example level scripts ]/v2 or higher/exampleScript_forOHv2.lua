...
march31oPatDel_isRebootingSide = false; --reboot side if target side has same (FOR PATTERNS ONLY) (optional)
march31oPatDel_AdditionalDelay = 0; --delay increment after patterns loaded (FOR PATTERNS ONLY) (optional)
march31oPatDel_AddMult = 1; --additional delay mult, alternation of delay multiplier...i think (FOR PATTERNS ONLY) (optional)
-- delay config (optional)
